...
class Settings(BaseSettings):
    ...
    # Override scraper RSS cadence (jobs between ABB recent polls). None = 1 when
    # abb_rss_only + ABB_PROXY_URL, 10 when abb_rss_only without proxy, else 3.
    ...
    github_token: str = ""
    # Clients below this versionCode must update (1.58 == 59). Admin can raise further.
    android_min_version_code: int = 59
