...
async def share_offline(token: str, db: AsyncSession = Depends(get_db)):
    ...
    return {
        "sessionId": "",
        "itemId": share.abs_item_id,
        "absItemId": share.abs_item_id,
        "tracks": info["tracks"],
        "startOffset": 0.0,
        "coverUrl": info.get("coverUrl") or "",
        "title": info.get("title") or "Audiobook",
        "author": info.get("author") or "",
        "narrator": info.get("narrator") or "",
        "subtitle": info.get("subtitle") or "",
        "seriesName": info.get("seriesName") or "",
        "sequence": info.get("sequence") or "",
        "series": info.get("series") or [],
        "description": info.get("description") or "",
        "asin": info.get("asin") or "",
        "genres": info.get("genres") or [],
        "publishedYear": info.get("publishedYear") or "",
